...
With the request, the user is trying to create a photobook. Use all that you can infer from the uploaded photos and do the following.
    ...
    2. For each page, optionally write a message in 1-3 sentences to celebrate the occasion identified by the photos you chose on that page if you see fit. Tone: Casual, celebratory, romantic, don't use words too fancy so it sounds cringe or insincere.; Remember: The message should sound super natural as if the user is trying to convey the message to the photobook viewer. Use emojis sparingly where you see fit, but don't over do it.
    3. For the photo book you create, come up with a short title less than 10 words.
...
<response>
<title>Our trip to Japan</title>
<page>
    <photo><id>123.png</id></photo>
    <photo><id>abc.png</id></photo>
    <img>[page_message]</img>
</page>
<page>
    <photo><id>a23.png</id></photo>
    <photo><id>b45.jpg</id></photo>
    <img>[page_message]</img>
</page>
</response>"""
